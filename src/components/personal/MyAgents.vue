<template>
    <div>
        <PageTitle title="子商家用户"></PageTitle>
        <div class="pageWrapper">
            <div class="lookWrapper" v-if="!edit">
                <div class="searchWrapper">
                    ...
                    <span style="margin-left: 5px;">总营业额：{{totalMoney}}元</span>
                ...
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" label-position="top" v-loading="loading">
                    <div class="form-item">
                        <el-form-item label="用户类型" prop="type">
                            ...
                            <el-radio border v-model="ruleForm.type" size="medium" label="agent" :disabled="activeUserId ? true : false">子商家</el-radio>
                        </el-form-item>
                    </div>
                    <div class="form-item">
                        <div class="left">
