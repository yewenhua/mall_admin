        ...
        <div class="pageWrapper">
            <div class="updateWrapper">
                ...
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" label-position="top" v-loading="loading">
                    <el-form-item label="商家" prop="uid">
                        <el-select v-model="searchUid" placeholder="商家" @change="chgUid" size="medium" style="width: 100%;">
                    ...
                    <el-form-item label="分成比列（%）" prop="value">
                        <el-input v-model="ruleForm.value" type="number" min="0" max="100" placeholder="请输入分成比列"></el-input>
                    </el-form-item>
                    <el-form-item>
